...
# ACDS 23.1 993 linux 2025.07.13.15:42:16
...
# ----------------------------------------
# If sincos is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sincos_CORDIC_0.vhd"       -work CORDIC_0 -cdslib ./cds_libs/CORDIC_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/sincos.vhd"                                                                             
fi
