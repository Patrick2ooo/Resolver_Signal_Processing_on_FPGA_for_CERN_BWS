...
# ACDS 23.1 993 linux 2025.07.16.16:12:03
...
# ----------------------------------------
# If vector_translate is one of several IP cores in your
...
TOP_LEVEL_NAME="vector_translate"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dspba_library_package.vhd"     -work CORDIC_0 -cdslib ./cds_libs/CORDIC_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dspba_library.vhd"             -work CORDIC_0 -cdslib ./cds_libs/CORDIC_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/vector_translate_CORDIC_0.vhd" -work CORDIC_0 -cdslib ./cds_libs/CORDIC_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/vector_translate.vhd"                                                                       
fi
